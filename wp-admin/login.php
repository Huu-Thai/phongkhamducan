<?php
	session_start();
	if(isset($_SESSION['tg_login_id'],$_SESSION['tg_login_user'],$_SESSION['tg_login_level']))
	{
		header("location: main.php"); //khanh sửa lại
	}	
	ob_start();
	if (isset($_POST['btnLog'])!="") //khanh sửa lại
	{	
		...
		{
			if (isset($_POST['nho'])!="") //khanh sửa lại
			{
