...
<tr>  	<td class="anhien">{id}</td>
        <td>{TieuDe}</td>
		<td>{TomTat}</td>
		<td class="anhien"><a class="smallButton anhien" id="ma_{id}"  AnHien="bang=pages&ma=idPage&id={id}"  href="#"><img  src="images/ah_{AnHien}.png"></a></td>
...
<?php
$str = ob_get_clean();
$str = str_replace("{id}",$row_loaisp['idPage'],$str);
