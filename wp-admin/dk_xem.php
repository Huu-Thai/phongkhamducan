<?php
  ...
  if(isset($_GET['sdt'])){$sdt = $_GET['sdt'];}else{$sdt="";}
...
<p>
<a href="main.php?p=dk_xem"><input type="button" style="width:200px" value="Cập Nhật" /></a>
<a href="main.php?p=dk_xem&khongcapnhat=1"><input type="button" style="width:200px" value="Dừng Cập Nhật" /></a>
</p>
<br/>
