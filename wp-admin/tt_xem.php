...
<tr>    <td class="anhien">{id}</td>
    ...
    <td>{TomTat}</td>
    <td class="anhien"><a class="smallButton anhien" id="ma_{id}"  AnHien="bang=tintuc&ma=idTinTuc&id={id}"  href="#"><img  src="images/ah_{AnHien}.png"></a></td>
        <td align="center">
...
<?php
$str = ob_get_clean();
$str = str_replace("{id}",$row_loaisp['idTinTuc'],$str);
