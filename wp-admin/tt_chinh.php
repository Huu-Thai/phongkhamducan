<?php
  ...
  if (isset($_POST['btnPreView'])==true)
	{
    $linktest = "../".$row_sanpham["TieuDeKD"].".html";
		...
		echo "<script>
			...
			var popup = window.open('$linktest', 'popup_window', params); 
			popup.moveTo(0,0);
...
<!-- <tr><td width="100">Link</td>
     <td><input type="text" name="TieuDeKD" id="TieuDeKD" value="<?php echo $row_sanpham['TieuDeKD'] ?>" readonly /></td>
</tr> -->
<tr><td>Hình Ảnh</td>
     <td>
...
<tr><td width="100">H1</td>
    <td><input type="text" name="H1" id="Keyword" value="<?php echo $row_sanpham['H1'] ?>" readonly /></td>
</tr>
