...
<div class="bodytext" id="hello">Chào bạn: <a href="#"><?=$_SESSION['tg_login_user']?></a>,
					...
					switch ($p)
						{	
							...
							case "cd_xem":
								...
								break;
							case "cd_chinh":
								include "cd_chinh.php";
								break;
							case "cd_them":
								include "cd_them.php";
								break;

							case "cauhinhchung_xem":
								include "cauhinhchung_xem.php";
								break;
							case "cauhinhchung_chinh":
								include "cauhinhchung_chinh.php";
								break;

							case "menu_xem":
								include "menu_xem.php";
								break;
							case "menu_chinh":
								include "menu_chinh.php";
								break;
							case "menu_them":
								include "menu_them.php";
								break;
							case "check_comment":
								include "check_comment.php";
								break;
