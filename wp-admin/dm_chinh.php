     ...
     <td>
      <select  id="Parent" name="Parent">
        ...
        <?php while ($row_dm = mysql_fetch_assoc($danhmuc)) { ?>
            <option <?php if ($row_dm['idLoaiTin'] == $row_sanpham['idLoaiCha']){ echo "selected='selected'"; } ?> value="<?php echo $row_dm['idLoaiTin']; ?>" style="font-weight:bold"><?php echo $row_dm['TieuDe']; ?></option>
      <?php 
